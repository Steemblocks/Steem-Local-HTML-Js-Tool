...
2. Open the `index.html` file from **Delegate Steem** folder for the **STEEM Delegation Tool** or the `index.html` file from **Cancel Delegation** folder for the **STEEM Cancel Delegation Tool** in your web browser. 
